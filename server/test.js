...
async function runTests() {
  ...
  assert(msg4.type === 'offer' && msg4.sdp === 'test-offer', 'Test 3 failed');
  ...
  assert(msg5.type === 'rejected' && msg5.reason === 'broadcaster-exists', 'Test 4 failed');
  console.log('✓ Test 4: Reject duplicate broadcaster');

  // Test 5: Peer left notification
  v.close();
  const msg6 = await waitForMessage(b);
  assert(msg6.type === 'peer-left', `Test 5 failed: expected peer-left, got ${msg6.type}`);
